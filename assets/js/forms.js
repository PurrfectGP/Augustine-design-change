/* ==========================================================================
   forms.js — All form handlers: initForms(), selectContactType(),
   partnerships data (partnershipsAbstractIcons, partnershipsTierData,
   partnershipsCurrentTier), initPartnerships(), updatePartnershipsContent(),
   renderPartnershipsBoxes(), openPartnershipsModal(), closePartnershipsModal(),
   handlePartnershipsSubmit().
