/* ==========================================================================
   animations.js — Science card animations: globalAnimationsPaused state,
   visual card eye animation (initVisualCardAnimation, triggerVisualCardAnimation,
   resetVisualCardAnimation), personality card animation, genetic card animation,
   synthesis card animation, showAllCardsCompleted(), hideAllCardsCompleted(),
   toggleAllAnimations(). All window.* exports for cross-module access.
   Depends on: nothing (standalone; called from main.js DOMContentLoaded)
   ========================================================================== */
